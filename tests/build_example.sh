...
paplot mutation ${data_dir}/mutation_subplot/data.csv  ./demo mutation_subplot  --ellipsis subplot  -c /home/travis/build/aokad/paplot/tests/example/mutation_subplot/paplot.cfg
